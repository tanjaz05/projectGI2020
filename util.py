...
def print_command_line_arguments():
    ...
    print("fasta file: ", globalVariables.fastaFile)
    print("fastq file: ", globalVariables.fastqFile)
    print("seed length: ", globalVariables.seed_length)
    print("margin: ", globalVariables.margin)
    print("Scoring matrix values:")
    print("match: ", globalVariables.match)
    print("mismatch: ", globalVariables.replacement)
    print("insertion/deletion: ", globalVariables.insertion)
